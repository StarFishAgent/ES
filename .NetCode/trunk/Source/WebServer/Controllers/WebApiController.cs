...
namespace WebServer.Controllers
{
    ...
    public class WebApiController : ControllerBase
    {
        ...
        public ActionResult EQER([FromBody] JsonElement Parameters) {
            var ParamsJson = JsonConvert.DeserializeObject<dynamic>(Parameters.ToString());
           
            return new ContentResult() { Content = JsonConvert.SerializeObject(ExamHelper.CountExamResult(Convert.ToString(ParamsJson.ExamGuid), ParamsJson.Answers)), ContentType = "application/json", StatusCode = 200 };
        }
